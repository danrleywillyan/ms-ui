...
export class RequestElucidationComponent implements OnInit {
  ...
  occurrenceTypes = [
    ...
    {id: 49, name: '49 - Ausência da dosagem do medicamento na receita médica (mg/ml)'},
    {id: 50, name: '50 - Dispensado medicamento X em quantidade superior ao prescrito na receita médica'},
    {id: 51, name: '51 - Dispensado medicamento X em quantidade superior ao permitido pelo programa'},
    {id: 52, name: '52 - Ausência de impressão digital ou assinatura do paciente/outorgante na procuração'},
    {id: 53, name: '53 - Informações do cupom vinculado divergem da apresentada no sistema autorizador de vendas'},
    {id: 54, name: '54 - Outras'}
  ];
