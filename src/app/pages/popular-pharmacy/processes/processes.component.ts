...
export class ProcessesComponent implements OnInit {
  ...
  ngOnInit() {
    this.processes = [
      ...
      { title: 'Solicitar fusão e incorporação de empresa no PFPB [TO BE]', url: '', status: 'a fazer', pdf: `` },
      { title: 'Renovar Credenciamento de Empresa', url: '', status: 'a fazer', pdf: `` },
      { title: 'Dispensar medicamentos pelas empresas credenciadas no PFPB', url: '', status: 'a fazer', pdf: `` },
      ...
      { title: 'Realizar auditoria em empresas credenciadas no PFPB', url: '', status: 'a fazer', pdf: `` },
      { title: 'Multar empresa credenciada no PFPB', url: '', status: 'a fazer', pdf: `` },
      { title: 'Realizar cobrança administrativa de farmácia credenciada no PFPB', url: '', status: 'a fazer', pdf: `` },
      { title: 'Realizar cobrança administrativa de farmácia credenciada no PFPB', url: '', status: 'a fazer', pdf: `` },
      { title: 'Tratar empresa inadimplente no PFPB', url: '', status: 'a fazer', pdf: `` },
